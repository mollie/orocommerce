...
/**
 * Class MolliePlaceholderPasswordType
 *
 * @package Mollie\Bundle\PaymentBundle\Form\Type
 */
class MolliePasswordType extends AbstractType
{
    const PLACEHOLDER_OPTIONS = 'oro_placeholder_options';
    const PLACEHOLDER_OPTIONS_ORIGINAL_DATA = 'original_data';
